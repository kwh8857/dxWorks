const propertyLeftArray = [
  {
    el: document.getElementById("property-top-text"),
    delay: 0.1,
    trans: 2,
  },
  {
    el: document.getElementById("property-middle-text"),
    delay: 0.2,
    trans: 2,
  },
];
...
propertyLeftArray.forEach(({ el, delay, trans }) => {
